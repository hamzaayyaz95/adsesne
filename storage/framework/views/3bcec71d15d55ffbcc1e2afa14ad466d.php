        ...
        <div class="p-0 container-fluid max-lg:w-full">
            <h1 class="flex items-center ps-[1.25rem] pe-9 min-h-[--lqd-header-height] max-w-full relative max-lg:hidden group-[.navbar-shrinked]/body:w-full group-[.navbar-shrinked]/body:px-0 group-[.navbar-shrinked]/body:text-center group-[.navbar-shrinked]/body:justify-center">
                <a class="block px-0" href="<?php echo e(LaravelLocalization::localizeUrl( route('dashboard.index') )); ?>">
					...
					<?php if(isset($setting->logo_dashboard)): ?>
						<img src="/<?php echo e($setting->logo_dashboard_path); ?>" <?php if( isset($setting->logo_dashboard_2x_path) ): ?> srcset="/<?php echo e($setting->logo_dashboard_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?>" class="w-full h-auto group-[.navbar-shrinked]/body:hidden dark:hidden">
						<img src="/<?php echo e($setting->logo_dashboard_dark_path); ?>" <?php if( isset($setting->logo_dashboard_dark_2x_path) ): ?> srcset="/<?php echo e($setting->logo_dashboard_dark_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?>" class="w-full h-auto hidden group-[.navbar-shrinked]/body:hidden dark:block">
					<?php else: ?>
						<img src="/<?php echo e($setting->logo_path); ?>" <?php if( isset($setting->logo_2x_path) ): ?> srcset="/<?php echo e($setting->logo_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?>" class="w-full h-auto group-[.navbar-shrinked]/body:hidden dark:hidden">
						<img src="/<?php echo e($setting->logo_dark_path); ?>" <?php if( isset($setting->logo_dark_2x_path) ): ?> srcset="/<?php echo e($setting->logo_dark_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?>" class="w-full h-auto hidden group-[.navbar-shrinked]/body:hidden dark:block">
					<?php endif; ?>

					<!-- collapsed -->
					<img src="/<?php echo e($setting->logo_collapsed_path); ?>" <?php if( isset($setting->logo_collapsed_2x_path) ): ?> srcset="/<?php echo e($setting->logo_collapsed_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?>" class="w-full h-auto hidden max-w-[40px] mx-auto group-[.navbar-shrinked]/body:block dark:!hidden">
					<img src="/<?php echo e($setting->logo_collapsed_dark_path); ?>" <?php if( isset($setting->logo_collapsed_dark_2x_path) ): ?> srcset="/<?php echo e($setting->logo_collapsed_dark_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?>" class="w-full h-auto hidden max-w-[40px] mx-auto group-[.theme-dark.navbar-shrinked]/body:block">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="primary-nav navbar-nav max-lg:py-4 max-lg:px-3">
					...
					<?php endif; ?>
					<li class="nav-item">
						<a class="nav-link <?php echo e(route('dashboard.user.openai.generator.workbook', 'ai_code_generator') == url()->current() ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.admin.google-adsenses.index')); ?>">
							<span class="nav-link-icon">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path d="M8 9l3 3l-3 3"></path> <path d="M13 15l3 0"></path> <path d="M3 4m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z"></path> </svg>
							</span>
							<span class="flex items-center transition-[opacity,transform] nav-link-title grow">
								<?php echo e(__('Google Adsense')); ?>
					...
					<?php endif; ?>
					<?php if( $setting->feature_ai_voiceover ): ?>
					<li class="nav-item">
						<a class="nav-link <?php echo e(route('dashboard.user.openai.generator', 'ai_voiceover') == url()->current() ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.user.openai.generator', 'ai_voiceover')); ?>">
							<span class="nav-link-icon">
                    ...
                    <?php if(Auth::user()->type == 'admin'): ?>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle <?php echo e(activeRouteBulk(['dashboard.admin.openai.list', 'dashboard.admin.openai.custom.list', 'dashboard.admin.openai.chat.list', 'dashboard.admin.openai.categories.list'])); ?>" href="#navbar-help" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false" >
								<span class="nav-link-icon">
                            ...
                            <div class="dropdown-menu <?php echo e(activeRouteBulkShow(['dashboard.admin.openai.list', 'dashboard.admin.openai.custom.list', 'dashboard.admin.openai.chat.list', 'dashboard.admin.openai.categories.list'])); ?>">
                                ...
                                <a class="dropdown-item <?php echo e(activeRoute('dashboard.admin.openai.categories.list')); ?>" href="<?php echo e(route('dashboard.admin.openai.categories.list')); ?>">
                                    <?php echo e(__('AI Writer Categories')); ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu <?php echo e(activeRouteBulkShow(['dashboard.admin.frontend.settings', 'dashboard.admin.frontend.faq.index', 'dashboard.admin.frontend.tools.index', 'dashboard.admin.testimonials.index', 'dashboard.admin.frontend.future.index', 'dashboard.admin.frontend.whois.index', 'dashboard.admin.frontend.generatorlist.index', 'dashboard.admin.clients.index','dashboard.admin.howitWorks.index', 'dashboard.admin.frontend.sectionsettings', 'dashboard.admin.frontend.menusettings' ])); ?>">
                                ...
                                <a class="dropdown-item <?php echo e(activeRoute('dashboard.admin.frontend.menusettings')); ?>" href="<?php echo e(route('dashboard.admin.frontend.menusettings')); ?>">
                                    <?php echo e(__('Menu')); ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu <?php echo e(activeRouteBulkShow(['dashboard.admin.settings.general', 'dashboard.admin.settings.invoice', 'dashboard.admin.settings.payment', 'dashboard.admin.settings.openai', 'dashboard.admin.settings.affiliate','dashboard.admin.settings.smtp', 'amamarul.translations.home', 'amamarul.translations.lang', 'dashboard.admin.settings.gdpr', 'dashboard.admin.settings.privacy', 'dashboard.admin.settings.tts' ])); ?>">
                                ...
                                <a class="dropdown-item <?php echo e(activeRoute('dashboard.admin.settings.tts')); ?>" href="<?php echo e(route('dashboard.admin.settings.tts')); ?>">
                                    <?php echo e(__('Google TTS')); ?>
                                ...
                                <a class="dropdown-item <?php echo e(activeRoute('dashboard.admin.settings.gdpr')); ?>" href="<?php echo e(route('dashboard.admin.settings.gdpr')); ?>">
                                    <?php echo e(__('GDPR')); ?>

                                </a>
                                <a class="dropdown-item <?php echo e(activeRoute('dashboard.admin.settings.privacy')); ?>" href="<?php echo e(route('dashboard.admin.settings.privacy')); ?>">
                                    <?php echo e(__('Privacy Policy and Terms')); ?>

                                </a>
                                <a class="dropdown-item <?php echo e(activeRoute('amamarul.translations.home')); ?> <?php echo e(activeRoute('amamarul.translations.lang')); ?>" href="<?php echo e(LaravelLocalization::localizeUrl( route('amamarul.translations.home') )); ?>">
...
<header class="navbar navbar-expand-md navbar-light flex max-lg:h-[65px]">
    <div class="container-xl flex-nowrap !items-stretch">
		<div class="hidden items-center max-lg:flex max-lg:gap-3">
			...
			<a class="hidden max-lg:flex items-center justify-center shrink-0 lg:px-2 max-md:max-w-[120px]" href="<?php echo e(LaravelLocalization::localizeUrl( route('dashboard.index') )); ?>">
            ...
            <div class="flex gap-[18px] max-lg:gap-2">
				...
				<div class="nav-item dropdown">
					<a href="#" class="p-0 nav-link d-flex lh-1 text-reset" data-bs-toggle="dropdown" aria-label="Open user menu">
						<span class="avatar avatar-sm max-lg:w-10 max-lg:h-10" style="background-image: url(<?php if(!Auth::user()->github_token && !Auth::user()->google_token && !Auth::user()->facebook_token): ?>/<?php endif; ?><?php echo e(Auth::user()->avatar); ?>)"></span>
					</a>
					<div class="dropdown-menu dropdown-menu-end">
...
<?php /**PATH D:\laragon\www\adsense\resources\views/panel/layout/header.blade.php ENDPATH**/ ?>