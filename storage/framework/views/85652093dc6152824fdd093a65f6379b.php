            ...
            <div class="flex flex-col justify-center col-lg-6">
				<div class="row">
					<div class="mx-auto col-lg-6">
						<h1 class="text-center mb-11"><?php echo e(__('Sign in')); ?></h1>
						...
						<form novalidate="novalidate" onsubmit="return LoginForm();">
							<div class="mb-[20px]">
								...
								<input type="email" class="form-control" id="email" placeholder="your@email.com" value="<?php echo e(env('APP_STATUS') == 'Demo' ? 'admin@admin.com' : ''); ?>" autocomplete="off">
							</div>
							<div class="mb-[25px]">
								...
								<div class="input-group">
									<input type="password" class="form-control" id="password" placeholder="Your password" value="<?php echo e(env('APP_STATUS') == 'Demo' ? '12345678' : ''); ?>" autocomplete="off">
							...
							<div class="row">
								...
								<div class="col !text-end">
									<a href="<?php echo e(route('forgot_password')); ?>"><?php echo e(__('Forgot Password?')); ?></a>
								</div>
							</div>
							<div class="row mt-[25px]">
								<div class="col">
									<button id="LoginFormButton" class="btn btn-primary w-100"><?php echo e(__('Sign in')); ?></button>
								</div>
							</div>
                            <!-- TODO Openai Demo -->
                            <?php if(env('APP_STATUS') == 'Demo'): ?>
                                <hr class="my-10">
                                <h3 class="card-title text-heading"><?php echo e(__('Test Credentials')); ?></h3>
                                <div class="card">
...
<?php echo $__env->make('panel.layout.app_without_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/panel/authentication/login.blade.php ENDPATH**/ ?>