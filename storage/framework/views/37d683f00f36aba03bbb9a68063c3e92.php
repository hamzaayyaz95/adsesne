				...
				<div id="table-default" class="card-table table-responsive">
					<table class="table">
						...
						<tr>
							...
							<th><?php echo e(__('Tokens Used')); ?></th>
							<th class="max-sm:min-w-[250px]"><?php echo e(__('Output')); ?></th>
						...
						<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($entry->generator != null): ?>
                                <?php if($entry->generator->type != 'image'): ?>
									...
									<span class="avatar w-[43px] h-[43px] [&_svg]:w-[20px] [&_svg]:h-[20px]" style="background: <?php echo e($entry->generator->color); ?>">
                                        ...
                                        <td class="sort-category"><?php echo e($entry->generator->title); ?></td>
                                        <td class="sort-tokens"><?php echo e($entry->credits); ?></td>
                                        <?php if($entry->generator->type == 'text'): ?>
                                            <td class="max-sm:min-w-[250px]">
                                                <?php echo e(\Illuminate\Support\Str::limit(strip_tags($entry->output), 200)); ?>

                                            </td>
                                        <?php elseif($entry->generator->type == 'audio'): ?>
                                            <td class="max-sm:min-w-[250px]">
                                                <?php echo \Illuminate\Support\Str::limit($entry->output, 200); ?>

                                            </td>
                                        <?php elseif($entry->generator->type == 'code'): ?>
                                            <td class="max-sm:min-w-[250px]">
                                                <?php echo e(\Illuminate\Support\Str::limit(strip_tags($entry->output), 200)); ?>

                                            </td>
                                        <?php elseif($entry->generator->type == 'voiceover'): ?>
                                            <td class="max-sm:min-w-[250px] data-audio" data-audio="/uploads/<?php echo e($entry->output); ?>">
												<div class="audio-preview"></div>
                                            </td>
                                        <?php else: ?>
                                            <td class="max-sm:min-w-[250px]">
                                                <a href="<?php echo e($entry->output); ?>" target="_blank"><img src="<?php echo e($entry->output); ?>" class="img-fluid" alt=""></a>
                                            </td>
                                        <?php endif; ?>
                                        ...
                                        <td class="!text-end whitespace-nowrap">
                                           <?php if($entry->generator->type == 'voiceover'): ?>
                                                <a href="/uploads/<?php echo e($entry->output); ?>" target="_blank" class="btn relative z-10 w-[36px] h-[36px] p-0 border hover:bg-[var(--tblr-primary)] hover:text-white" title="<?php echo e(__('View and edit')); ?>">
                                            ...
                                            <?php else: ?>
                                                <a href="<?php echo e(LaravelLocalization::localizeUrl( route('dashboard.user.openai.documents.single', $entry->slug))); ?>" class="btn relative z-10 w-[36px] h-[36px] p-0 border hover:bg-[var(--tblr-primary)] hover:text-white" title="<?php echo e(__('View and edit')); ?>">
                                            ...
                                            <?php endif; ?>
                                            <a href="<?php echo e(LaravelLocalization::localizeUrl( route('dashboard.user.openai.documents.delete', $entry->slug))); ?>" onclick="return confirm('Are you sure?')" class="btn relative z-10 p-0 border w-[36px] h-[36px] hover:bg-red-600 hover:text-white" title="<?php echo e(__('Delete')); ?>">
                                        ...
                                        <td class="w-full h-full absolute top-0 left-0 border-0">
                                            <a href="<?php echo e(LaravelLocalization::localizeUrl( route('dashboard.user.openai.documents.single', $entry->slug))); ?>" class="absolute top-0 left-0 w-full h-full z-[2]" title="<?php echo e(__('View and edit')); ?>"></a>
                                        </td>
                                        <?php endif; ?>
                                    </tr>
                                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\adsense\resources\views/panel/user/openai/documents.blade.php ENDPATH**/ ?>