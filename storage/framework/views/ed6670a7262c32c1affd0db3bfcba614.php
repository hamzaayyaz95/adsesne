	...
	<div class="relative">
		<div class="container mb-28">
			<div class="w-1/2 mx-auto text-center max-lg:w-10/12 max-sm:w-full">
				<p class="text-xs font-semibold tracking-widest uppercase mb-9"><span class="inline-block px-3 py-1 !me-2 rounded-xl bg-[#262626]"><?php echo e(__($setting->site_name)); ?></span> <?php echo e(__($fSetting->footer_text_small)); ?></p>
				<p class="text-[100px] font-bold font-oneset leading-none tracking-tight mb-8 text-transparent bg-clip-text bg-gradient-to-br from-transparent -from-[5%] to-white to-50% max-sm:text-[18vw]"><?php echo e(__($fSetting->footer_header)); ?></p>
				<p class="text-[20px] font-oneset leading-[1.25em] opacity-50 font-normal mb-9 px-10"><?php echo e(__($fSetting->footer_text)); ?></p>
				<?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve(['link' => ''.e($fSetting->footer_button_url).'','label' => ''.e(__($fSetting->footer_button_text)).'','size' => 'lg','iconPos' => 'end','bg' => 'bg-white bg-opacity-10 border-[2px] border-white border-opacity-0 hover:bg-white hover:bg-opacity-100','text' => 'hover:!text-black'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
		...
		<div class="container">
			<div class="flex flex-wrap items-center justify-between gap-8 pt-10 pb-7 max-sm:justify-center">
				<a href="<?php echo e(route('index')); ?>">
					<?php if(isset($setting->logo_2x_path)): ?>
						<img src="/<?php echo e($setting->logo_path); ?>" srcset="/<?php echo e($setting->logo_2x_path); ?> 2x" alt="<?php echo e($setting->site_name); ?> logo">
					<?php else: ?>
						<img src="/<?php echo e($setting->logo_path); ?>" alt="<?php echo e($setting->site_name); ?> logo">
					<?php endif; ?>
				</a>
				<ul class="flex flex-wrap items-center gap-7 text-[14px] max-sm:justify-center">
					<?php if($setting->frontend_footer_instagram != null): ?>
                        <li>
                            <a href="<?php echo e($setting->frontend_footer_instagram); ?>" class="inline-flex items-center gap-2">
                    ...
                    <?php endif; ?>
                    <?php if($setting->frontend_footer_twitter != null): ?>
                        <li>
                            <a href="<?php echo e($setting->frontend_footer_twitter); ?>" class="inline-flex items-center gap-2">
                    ...
                    <?php endif; ?>
                    <?php if($setting->frontend_footer_facebook != null): ?>
                        <li>
                            <a href="<?php echo e($setting->frontend_footer_facebook); ?>" class="inline-flex items-center gap-2">
			...
			<div class="flex flex-wrap items-center justify-center gap-4 py-9 max-sm:text-center">
				<p class="text-[14px] opacity-60 !text-end"><?php echo e(__($fSetting->footer_copyright)); ?></p>
			</div>
		</div>
	</div>
</footer>
<?php /**PATH D:\laragon\www\adsense\resources\views/layout/footer.blade.php ENDPATH**/ ?>