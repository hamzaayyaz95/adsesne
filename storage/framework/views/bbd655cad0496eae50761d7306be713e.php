...
<div class="page page-auth page-register">
	<div class="absolute top-0 left-0 right-0 container-fluid">
		<div class="items-center p-8 row max-lg:px-1">
			<div class="col">
				<a href="<?php echo e(route('index')); ?>" class="navbar-brand navbar-brand-autodark">
					<?php if(isset($setting->logo_dashboard)): ?>
						<img src="/<?php echo e($setting->logo_dashboard_path); ?>" <?php if( isset($setting->logo_dashboard_2x_path) ): ?> srcset="/<?php echo e($setting->logo_dashboard_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?>" class="group-[.navbar-shrinked]/body:hidden dark:hidden">
						<img src="/<?php echo e($setting->logo_dashboard_dark_path); ?>" <?php if( isset($setting->logo_dashboard_dark_2x_path) ): ?> srcset="/<?php echo e($setting->logo_dashboard_dark_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?>" class="hidden group-[.navbar-shrinked]/body:hidden dark:block">
					<?php else: ?>
						<img src="/<?php echo e($setting->logo_path); ?>" <?php if( isset($setting->logo_2x_path) ): ?> srcset="/<?php echo e($setting->logo_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?>" class="group-[.navbar-shrinked]/body:hidden dark:hidden">
						<img src="/<?php echo e($setting->logo_dark_path); ?>" <?php if( isset($setting->logo_dark_2x_path) ): ?> srcset="/<?php echo e($setting->logo_dark_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?>" class="hidden group-[.navbar-shrinked]/body:hidden dark:block">
					<?php endif; ?>
				</a>
			</div>
			<div class="col !text-end">
				<a href="<?php echo e(route('index')); ?>" class="text-heading !no-underline lg:text-white">
				...
				<div class="row">
					<div class="mx-auto col-lg-6">
						...
						<div class="container-tight">
							<h1 class="mb-11"><?php echo e(__('Sign up')); ?></h1>
							...
							<div class="flex flex-wrap !gap-4 text-[13px] -tracking-[0.15px]]">
								...
								<a href="<?php echo e(route('login.github')); ?>" class="flex items-center w-[calc(50%-0.5rem)] grow !py-3 !px-4 border border-[--tblr-border-color] rounded-[10px] !no-underline text-heading transition-all hover:shadow-lg hover:-translate-y-1">
								...
								<a href="<?php echo e(route('login.twitter')); ?>" class="flex items-center w-[calc(50%-0.5rem)] grow !py-3 !px-4 border border-[--tblr-border-color] rounded-[10px] !no-underline text-heading transition-all hover:shadow-lg hover:-translate-y-1">
								...
								<a href="<?php echo e(route('login.google')); ?>" class="flex items-center w-[calc(50%-0.5rem)] grow !py-3 !px-4 border border-[--tblr-border-color] rounded-[10px] !no-underline text-heading transition-all hover:shadow-lg hover:-translate-y-1">
								...
								<a href="<?php echo e(route('login.facebook')); ?>" class="flex items-center w-[calc(50%-0.5rem)] grow !py-3 !px-4 border border-[--tblr-border-color] rounded-[10px] !no-underline text-heading transition-all hover:shadow-lg hover:-translate-y-1">
							...
							<form novalidate="novalidate" onsubmit="return RegisterForm();">
								<input type="hidden" id="affiliate_code" value="<?php echo e(Request::get('aff') ?? null); ?>">
								<div class="mb-[20px]">
									<label class="form-label"><?php echo e(__('Name')); ?></label>
									<input type="text" class="form-control" id="name_register" placeholder="<?php echo e(__('Your Name')); ?>" autocomplete="off" required>
								</div>
								<div class="mb-[20px]">
									<label class="form-label"><?php echo e(__('Last Name')); ?></label>
									<input type="text" class="form-control" id="surname_register" placeholder="<?php echo e(__('Your Last Name')); ?>" autocomplete="off" required>
								</div>
								<div class="mb-[20px]">
									<label class="form-label"><?php echo e(__('Email Address')); ?></label>
									<input type="email" class="form-control" id="email_register" placeholder="<?php echo e(__('your@email.com')); ?>" autocomplete="off" required>
								</div>
								<div class="mb-[20px]">
									...
									<div class="input-group input-group-flat">
										<input type="password" class="form-control" id="password_register" placeholder="<?php echo e(__('Your password')); ?>" autocomplete="off" required>
									</div>
								</div>
								<div class="mb-[25px]">
									<label class="form-label">
									...
									<div class="input-group input-group-flat">
										<input type="password" class="form-control" id="password_confirmation_register" placeholder="<?php echo e(__('Password confirmation')); ?>" autocomplete="off" required>
									</div>
								</div>
								<div class="row mt-[35px]">
									<div class="col">
										<button id="RegisterFormButton" class="btn btn-primary w-100"><?php echo e(__('Sign up')); ?></button>
									</div>
								</div>
							</form>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="alert alert-danger"><?php echo e(__('Registration is currently unavailable.')); ?></div>
							</div>
						</div>
						<?php endif; ?>
						<?php if($setting->privacy_enable == 1 && $setting->privacy_enable_login == 1): ?>
							<div class="mt-3 text-center text-muted">
								...
								<a href="<?php echo e(url('/terms')); ?>" target="_blank" tabindex="-1" class="font-medium underline"><?php echo e(__('Terms and Conditions')); ?></a>
								<?php echo e(__('and')); ?>

								<a href="<?php echo e(url('/privacy-policy')); ?>" target="_blank" tabindex="-1" class="font-medium underline"><?php echo e(__('Privacy Policy')); ?></a>.
							</div>
						<?php endif; ?>
						<div class="mt-10 text-center text-muted">
							<?php echo e(__('Have an account?')); ?> <a href="<?php echo e(route('login')); ?>" tabindex="-1" class="font-medium underline"><?php echo e(__('Sign in')); ?></a>
						</div>
					</div>
				</div>
			</div>
...
<?php echo $__env->make('panel.layout.app_without_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/panel/authentication/register.blade.php ENDPATH**/ ?>