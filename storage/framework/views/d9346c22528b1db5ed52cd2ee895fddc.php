						...
						<div class="card-body p-10">
							<div class="row">
								<div class="col-12 col-md-5">
									<h4 class="w-10/12 mb-10 text-[20px] leading-[1.3em]"><?php echo e(__('Invite your friends and earn commision from their first purchase.')); ?>🎁</h4>
									<p class="mb-2 text-heading text-[13px]"><?php echo e(__('Affiliate Link')); ?></p>
									<div class="flex items-center relative">
										<input id="ref-code" class="form-control h-10 bg-white border-0 dark:!border-[1px] dark:!border-solid dark:!border-[#243049] dark:!bg-transparent dark:text-white" type="text" disabled value="<?php echo e(url('/')); ?>/register?aff=<?php echo e(\Illuminate\Support\Facades\Auth::user()->affiliate_code); ?>">
								...
								<div class="col-12 col-md-4 ms-auto text-center text-heading font-semibold max-md:-order-1 max-md:!text-start max-md:mb-3">
									<h4 class="mb-0 text-[16px]"><?php echo e(__('Earnings')); ?></h4>
									<p class="mb-2 text-[58px]">$<?php echo e($totalEarnings-$totalWithdrawal); ?></p>
									<p class="mb-0"><span class="opacity-60"><?php echo e(__('Comission Rate')); ?>:</span> <?php echo e($setting->affiliate_commission_percentage); ?>%</p>
									<p class="mb-0"><span class="opacity-60"><?php echo e(__('Referral Program')); ?>:</span> <?php echo e(__('All Purchases')); ?></p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-6">
					<div class="card text-heading">
						<div class="card-body flex flex-col py-6 px-8">
							<h2 class="mb-[1em]"><?php echo e(__('How it works')); ?></h2>
							<ol class="list-none p-0 ml-0 mb-7">
								...
								<li class="mb-[18px]">
									...
									<?php echo __('You <strong>start earning commision</strong> from their first purchase.'); ?>

								</li>
							</ol>
							<p class="mb-2 mt-auto text-heading text-[13px]"><?php echo e(__('Affiliate Link')); ?></p>
                            <form id="send_invitation_form" onsubmit="return sendInvitationForm();">
                                <div class="flex items-center relative">
                                    <input class="form-control h-10" type="email" name="to_mail" id="to_mail" placeholder="<?php echo e(__('Email address')); ?>" required>
                                ...
                                <button type="submit" id="send_invitation_button" form="send_invitation_form" class="btn btn-primary mt-2 w-100 rounded-[10px]"><?php echo e(__('Send')); ?></button>
                            </form>
				...
				<div class="col-lg-6">
					<div class="card">
						<div class="card-body py-6 px-8">
							<h2 class="mb-[1em]"><?php echo e(__('Withdrawal Form')); ?></h2>
							<form id="send_request_form" onsubmit="return sendRequestForm();">
								<div class="mb-[15px]">
									<label class="form-label" for="affiliate_bank_account"><?php echo e(__('Your Bank Information')); ?></label>
									<textarea class="form-control" rows="2" name="affiliate_bank_account" id="affiliate_bank_account" placeholder="<?php echo e(__('Bank of America - 2382372329 3843749 2372379')); ?>"><?php echo e(Auth::user()->affiliate_bank_account ?? null); ?></textarea>
								</div>

								<div class="mb-[20px]">
									<label class="form-label" for="affiliate_bank_account"><?php echo e(__('Amount')); ?></label>
									<input type="number" class="form-control h-10" name="amount" id="amount" min="<?php echo e($setting->affiliate_minimum_withdrawal); ?>" placeholder="<?php echo e(__('Minimum Withdrawal Amount is')); ?> <?php echo e($setting->affiliate_minimum_withdrawal); ?>">
								</div>

								<button type="submit" id="send_request_button" form="send_request_form" class="btn btn-primary w-100 rounded-[10px]"><?php echo e(__('Send Request')); ?></button>
							</form>
						</div>
					</div>
				</div>
						...
						<div class="card-body">
							...
							<div id="table-default-2" class="table-responsive">
								<table class="table">
									<thead>
									<tr>
										<th><button class="table-sort" data-sort="sort-id"><?php echo e(__('No')); ?></button></th>
										<th><button class="table-sort" data-sort="sort-amount"><?php echo e(__('Amount')); ?></button></th>
										<th><button class="table-sort" data-sort="sort-status"><?php echo e(__('Status')); ?></button></th>
										<th><button class="table-sort" data-sort="sort-date"><?php echo e(__('Date')); ?></button></th>
									</tr>
									</thead>
									...
									<?php if(count($list) == 0): ?>
										<tr>
											<td colspan="4" class="text-center"><?php echo e(__('You have no withdraval request')); ?></td>
										</tr>
									<?php endif; ?>
...
<?php echo $__env->make('panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/panel/user/affiliate/index.blade.php ENDPATH**/ ?>