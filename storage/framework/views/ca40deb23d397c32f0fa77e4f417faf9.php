<div class="flex items-center justify-center px-3 h-12 absolute inset-x-0 top-0 z-50 bg-[#343C57] text-center text-white text-sm bg-cover bg-blend-luminosity opacity-0 transition-all duration-500 group-[.page-loaded]/body:opacity-100" style="background-image: url(/assets/img/site/conffetti.png);">
	<p>
		<span class="mr-3 text-xs font-semibold tracking-wide uppercase"><?php echo e(__($fSetting->header_title)); ?></span>
		<span class="opacity-70"><?php echo e(__($fSetting->header_text)); ?></span>
	</p>
</div>
<header class="site-header absolute inset-x-0 top-12 z-50 text-white transition-[background,shadow] group/header [&.lqd-is-sticky]:bg-white [&.lqd-is-sticky]:shadow-[0_4px_20px_rgba(0,0,0,0.03)] [&.lqd-is-sticky]:text-black">
	<nav id="frontend-local-navbar" class="flex items-center justify-between py-4 border-b border-white px-7 border-opacity-10 relative text-[14px] opacity-0 max-sm:px-2 transition-all duration-500 group-[.page-loaded]/body:opacity-100 group-[.lqd-is-sticky]/header:border-black group-[.lqd-is-sticky]/header:border-opacity-5">
		<a href="<?php echo e(route('index')); ?>" class="site-logo basis-1/3 relative max-lg:basis-1/3">
			<?php if(isset($setting->logo_sticky)): ?>
			<img class="absolute top-1/2 start-0 opacity-0 -translate-y-1/2 translate-x-3 transition-all group-[.lqd-is-sticky]/header:opacity-100 group-[.lqd-is-sticky]/header:translate-x-0 peer" src="/<?php echo e($setting->logo_sticky_path); ?>" <?php if( isset($setting->logo_sticky_2x_path) ): ?> srcset="/<?php echo e($setting->logo_sticky_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?> logo">
			<?php endif; ?>
			<img class="transition-all group-[.lqd-is-sticky]/header:peer-first:opacity-0 group-[.lqd-is-sticky]/header:peer-first:translate-x-2" src="/<?php echo e($setting->logo_path); ?>" <?php if( isset($setting->logo_2x_path) ): ?> srcset="/<?php echo e($setting->logo_2x_path); ?> 2x" <?php endif; ?> alt="<?php echo e($setting->site_name); ?> logo">
		</a>
		...
		<div class="flex justify-end gap-2 basis-1/3 max-lg:basis-2/3">
			<div class="hidden md:block relative group">
				...
				<div class="min-w-[145px] bg-white shadow-lg opacity-0 translate-y-2 pointer-events-none absolute top-[calc(100%+1rem)] end-0 rounded-md text-black transition-all group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto">
                    ...
                    <a href="<?php echo e(LaravelLocalization::getLocalizedURL($localeCode, null, [], true)); ?>" rel="alternate" hreflang="<?php echo e($localeCode); ?>" class="block px-3 py-3 border-b border-black border-opacity-5 last:border-none transition-colors hover:bg-black hover:bg-opacity-5"><?php echo e(country2flag(substr($properties['regional'], strrpos($properties['regional'], '_') + 1))); ?> <?php echo e($properties['native']); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</div>
			</div>
			<?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve(['link' => ''.e(LaravelLocalization::localizeUrl( route('login') )).'','label' => ''.__($fSetting->sign_in).'','type' => 'outline','border' => 'border-[2px] border-white !border-opacity-10 group-[.lqd-is-sticky]/header:border-black','text' => 'text-white group-[.lqd-is-sticky]/header:text-black group-[.lqd-is-sticky]/header:hover:text-white'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<div class="fixed bottom-8 start-8 z-50">
	<a class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#262626] transition-all duration-300 hover:shadow-md hover:scale-110 hover:-translate-y-1" href="https://codecanyon.net/item/magicai-openai-content-text-image-chat-code-generator-as-saas/45408109" target="_blank" title="<?php echo e(__('Buy on Envato')); ?>">
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\adsense\resources\views/layout/header.blade.php ENDPATH**/ ?>