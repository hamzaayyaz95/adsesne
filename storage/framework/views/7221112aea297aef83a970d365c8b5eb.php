...
<div class="<?php echo e($wrapper_classname); ?>">
	...
	<?php endif; ?>
	<?php if( !empty( $image ) ): ?>
		<figure class="relative z-0 inline-block transition-all duration-300 <?php echo e($style === '2' ? 'mix-blend-multiply group-hover:scale-125' : 'group-hover:scale-105'); ?>">
			<?php echo e($image); ?>
	...
	<div class="relative shrink">
		<h4 class="<?php echo e($title_classname); ?>">
			...
			<?php if( !empty( $badge ) ): ?>
			<span class="uppercase tracking-wider text-[#5F499D] bg-[#5F499D] bg-opacity-10 text-[11px] font-semibold px-2 py-1 rounded-xl ml-3"><?php echo e($badge); ?></span>
			<?php endif; ?>
		</h4>
		<?php if( !empty( $desc ) ): ?>
...
</div><?php /**PATH D:\laragon\www\adsense\resources\views/components/box.blade.php ENDPATH**/ ?>